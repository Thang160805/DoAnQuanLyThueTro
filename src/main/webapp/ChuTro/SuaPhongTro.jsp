...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/SuaPhongTro.css">
<style>
.upload-area {
...
<%
	...
	<div class="container">
		<%
		PhongTro pt = (PhongTro) request.getAttribute("PhongTroCT");
		%>
		<h1 class="form-header">
			Sửa Thông Tin Phòng Trọ -
			<%=(pt != null && pt.getTenPhong() != null) ? pt.getTenPhong() : ""%></h1>
			...
			<div class="form-grid">
				...
				<div class="col-left">
					...
					<div class="card">
						...
						<div class="form-group">
							<label for="tenPhong">Tên phòng</label> <input type="text"
								...
								value="<%=(pt != null && pt.getTenPhong() != null) ? pt.getTenPhong() : ""%>">
						</div>

						<div class="form-group">
							<label for="diaChi">Địa chỉ chi tiết</label>
							<textarea id="diaChi" name="diaChi"><%=(pt != null && pt.getDiaChi() != null) ? pt.getDiaChi() : ""%></textarea>
						</div>
							...
							<div class="form-group">
								...
								<div class="input-with-unit">
									<input type="number" id="giaThue" name="giaThue"
										class="input-style"
										value="<%=(pt != null && pt.getGiaThue() != -1) ? pt.getGiaThue() : ""%>">
							...
							<div class="form-group">
								...
								<div class="input-with-unit">
									<input type="number" id="dienTich" name="dienTich"
										class="input-style"
										value="<%=(pt != null && pt.getDienTich() != -1) ? pt.getDienTich() : ""%>">
							...
							<div class="form-group">
								...
								<div class="input-with-unit">
									<input type="number" id="giaDien" name="giaDien"
										class="input-style"
										value="<%=(pt != null && pt.getGiaDien() != -1) ? pt.getGiaDien() : ""%>">
									<span class="input-unit">đ/kWh</span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="input-with-unit">
									<input type="number" id="giaNuoc" name="giaNuoc"
										class="input-style"
										value="<%=(pt != null && pt.getGiaNuoc() != -1) ? pt.getGiaNuoc() : ""%>">
									<span class="input-unit">đ/m³</span>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<textarea id="moTa" name="moTa"><%=(pt != null && pt.getMoTa() != null) ? pt.getMoTa() : ""%></textarea>
						</div>
					</div>
					...
					<div class="card">
						...
						<label>Chọn tiện ích có sẵn</label>
				...
				<div class="col-right">
					<div class="card">
						...
						<div class="image-preview-wrapper">
							<label>Ảnh Chính (Preview)</label> <img src=""
    ...
    $.ajax({
        url: "/DoAnQLThueTro/XuLyCapNhatThongTinPhong",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
        ...
        success: function (res) {
            if (res.success) {
                showToast(res.message || "Cập nhật phòng thành công!", "success");
                ...
                showToast(res.message || "Không thể cập nhật phòng!", "error");
            }
        },
